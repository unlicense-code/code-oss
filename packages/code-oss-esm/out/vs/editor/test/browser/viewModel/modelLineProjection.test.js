...
suite('Editor ViewModel - SplitLinesCollection', () => {
    ...
    function withSplitLinesCollection(text, callback) {
        ...
        const wrappingInfo = config.options.get(149 /* EditorOption.wrappingInfo */);
        const fontInfo = config.options.get(52 /* EditorOption.fontInfo */);
        const wordWrapBreakAfterCharacters = config.options.get(136 /* EditorOption.wordWrapBreakAfterCharacters */);
        const wordWrapBreakBeforeCharacters = config.options.get(137 /* EditorOption.wordWrapBreakBeforeCharacters */);
        const wrappingIndent = config.options.get(141 /* EditorOption.wrappingIndent */);
        const wordBreak = config.options.get(132 /* EditorOption.wordBreak */);
...
suite('SplitLinesCollection', () => {
    ...
    function withSplitLinesCollection(model, wordWrap, wordWrapColumn, callback) {
        ...
        const wrappingInfo = configuration.options.get(149 /* EditorOption.wrappingInfo */);
        const fontInfo = configuration.options.get(52 /* EditorOption.fontInfo */);
        const wordWrapBreakAfterCharacters = configuration.options.get(136 /* EditorOption.wordWrapBreakAfterCharacters */);
        const wordWrapBreakBeforeCharacters = configuration.options.get(137 /* EditorOption.wordWrapBreakBeforeCharacters */);
        const wrappingIndent = configuration.options.get(141 /* EditorOption.wrappingIndent */);
        const wordBreak = configuration.options.get(132 /* EditorOption.wordBreak */);
        const lineBreaksComputerFactory = new MonospaceLineBreaksComputerFactory(wordWrapBreakBeforeCharacters, wordWrapBreakAfterCharacters);
        const linesCollection = new ViewModelLinesFromProjectedModel(1, model, lineBreaksComputerFactory, lineBreaksComputerFactory, fontInfo, model.getOptions().tabSize, 'simple', wrappingInfo.wrappingColumn, wrappingIndent, wordBreak);
