...
export class ViewLayout extends Disposable {
    ...
    _configureSmoothScrollDuration() {
        this._scrollable.setSmoothScrollDuration(this._configuration.options.get(117 /* EditorOption.smoothScrolling */) ? SMOOTH_SCROLLING_TIME : 0);
    }
    ...
    onConfigurationChanged(e) {
        ...
        if (e.hasChanged(117 /* EditorOption.smoothScrolling */)) {
            this._configureSmoothScrollDuration();
        }
    }
    onFlushed(lineCount) {
    ...
    _getContentHeight(width, height, contentWidth) {
        ...
        if (options.get(108 /* EditorOption.scrollBeyondLastLine */)) {
            result += Math.max(0, height - options.get(68 /* EditorOption.lineHeight */) - options.get(86 /* EditorOption.padding */).bottom);
        }
        else if (!options.get(106 /* EditorOption.scrollbar */).ignoreHorizontalScrollbarInContentHeight) {
    ...
    _computeContentWidth() {
        ...
        if (wrappingInfo.isViewportWrapping) {
            ...
            const extraHorizontalSpace = options.get(107 /* EditorOption.scrollBeyondLastColumn */) * fontInfo.typicalHalfwidthCharacterWidth;
