...
export class MonospaceLineBreaksComputerFactory {
    static create(options) {
        return new MonospaceLineBreaksComputerFactory(options.get(137 /* EditorOption.wordWrapBreakBeforeCharacters */), options.get(136 /* EditorOption.wordWrapBreakAfterCharacters */));
    }
