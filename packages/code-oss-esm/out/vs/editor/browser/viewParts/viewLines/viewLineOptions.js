...
export class ViewLineOptions {
    constructor(config, themeType) {
        ...
        if (experimentalWhitespaceRendering === 'off') {
            this.renderWhitespace = options.get(102 /* EditorOption.renderWhitespace */);
        }
        else {
            // whitespace is rendered in a different layer
            this.renderWhitespace = 'none';
        }
        this.renderControlCharacters = options.get(97 /* EditorOption.renderControlCharacters */);
        ...
        this.stopRenderingLineAfter = options.get(120 /* EditorOption.stopRenderingLineAfter */);
