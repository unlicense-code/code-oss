...
export class ViewLines extends ViewPart {
    ...
    constructor(context, linesContent) {
        ...
        this._revealHorizontalRightPadding = options.get(103 /* EditorOption.revealHorizontalRightPadding */);
        ...
        this._stickyScrollEnabled = options.get(118 /* EditorOption.stickyScroll */).enabled;
        this._maxNumberStickyLines = options.get(118 /* EditorOption.stickyScroll */).maxLineCount;
    }
    dispose() {
    ...
    _computeScrollLeftToReveal(horizontalRevealRequest) {
        ...
        const layoutInfo = this._context.configuration.options.get(148 /* EditorOption.layoutInfo */);
