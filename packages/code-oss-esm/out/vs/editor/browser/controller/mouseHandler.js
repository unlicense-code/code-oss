...
export class MouseHandler extends ViewEventHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._height = this._context.configuration.options.get(148 /* EditorOption.layoutInfo */).height;
    ...
    onConfigurationChanged(e) {
        if (e.hasChanged(148 /* EditorOption.layoutInfo */)) {
            // layout change
            const height = this._context.configuration.options.get(148 /* EditorOption.layoutInfo */).height;
    ...
    _onMouseDown(e, pointerId) {
        ...
        const selectOnLineNumbers = this._context.configuration.options.get(112 /* EditorOption.selectOnLineNumbers */);
...
class TopBottomDragScrollingOperation extends Disposable {
    ...
    _getScrollSpeed() {
        ...
        const viewportInLines = this._context.configuration.options.get(148 /* EditorOption.layoutInfo */).height / lineHeight;
    ...
    _execute() {
        ...
        let mouseTarget;
        {
            ...
            const horizontalScrollbarHeight = this._context.configuration.options.get(148 /* EditorOption.layoutInfo */).horizontalScrollbarHeight;
