...
let NativeEditContext = class NativeEditContext extends AbstractEditContext {
    static { NativeEditContext_1 = this; }
    static { this.TEXT_AREA_CLASS_NAME = 'native-edit-context-textarea'; }
    constructor(context, overflowGuardContainer, viewController, _visibleRangeProvider, instantiationService, _accessibilityService) {
        super(context);
    ...
    _updateDomAttributes() {
        const options = this._context.configuration.options;
        this.domNode.domNode.setAttribute('tabindex', String(options.get(127 /* EditorOption.tabIndex */)));
    }
    _updateEditContext() {
    ...
    _updateSelectionAndControlBounds(ctx) {
        ...
        const contentLeft = options.get(148 /* EditorOption.layoutInfo */).contentLeft;
...
NativeEditContext = NativeEditContext_1 = __decorate([
