...
export declare class NativeEditContext extends AbstractEditContext {
    ...
    static TEXT_AREA_CLASS_NAME: string;
    ...
    constructor(context: ViewContext, overflowGuardContainer: FastDomNode<HTMLElement>, viewController: ViewController, _visibleRangeProvider: IVisibleRangeProvider, instantiationService: IInstantiationService, _accessibilityService: IAccessibilityService);
    dispose(): void;
    setAriaOptions(): void;
