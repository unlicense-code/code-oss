...
let CodeEditorWidget = class CodeEditorWidget extends Disposable {
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        const isDropIntoEnabled = () => {
            return !this._configuration.options.get(94 /* EditorOption.readOnly */)
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(134 /* EditorOption.wordSeparators */), this._configuration.options.get(133 /* EditorOption.wordSegmenterLocales */), position);
    }
    ...
    pushUndoStop() {
        ...
        if (this._configuration.options.get(94 /* EditorOption.readOnly */)) {
...
class EditorContextKeysManager extends Disposable {
    ...
    _updateFromConfig() {
        ...
        this._editorReadonly.set(options.get(94 /* EditorOption.readOnly */));
