...
let InlineEditsView = class InlineEditsView extends Disposable {
    constructor(_editor, _edit, _model, _instantiationService, _commandService) {
        ...
        this._useMixedLinesDiff = observableCodeEditor(this._editor).getOption(64 /* EditorOption.inlineSuggest */).map(s => s.edits.experimental.useMixedLinesDiff);
        this._useInterleavedLinesDiff = observableCodeEditor(this._editor).getOption(64 /* EditorOption.inlineSuggest */).map(s => s.edits.experimental.useInterleavedLinesDiff);
        ...
        this._previewEditorLeft = derived(this, reader => {
