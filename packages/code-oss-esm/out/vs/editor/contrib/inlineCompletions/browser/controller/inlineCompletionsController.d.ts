...
export declare class InlineCompletionsController extends Disposable {
    ...
    private readonly optionPreview;
    private readonly optionPreviewMode;
    private readonly optionMode;
    private readonly optionInlineEditsEnabled;
    ...
    protected readonly _inlineEditWidget: import("../../../../../base/common/observable.js").IObservable<InlineEditsViewAndDiffProducer | undefined, unknown>;
