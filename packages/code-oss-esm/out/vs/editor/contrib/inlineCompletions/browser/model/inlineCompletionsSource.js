...
let InlineCompletionsSource = class InlineCompletionsSource extends Disposable {
    ...
    constructor(_textModel, _versionId, _debounceValue, _languageFeaturesService, _languageConfigurationService, _logService, _configurationService, _contextKeyService) {
        super();
        ...
        this._recordingLoggingEnabled = observableContextKey('editor.inlineSuggest.logFetch', this._contextKeyService).recomputeInitiallyAndOnChange(this._store);
...
*/
export function formatRecordableLogEntry(sourceId, entry) {
