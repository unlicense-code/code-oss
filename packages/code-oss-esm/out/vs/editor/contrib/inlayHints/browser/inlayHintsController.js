...
let InlayHintsController = class InlayHintsController {
    ...
    _update() {
        ...
        this._removeAllDecorations();
        const options = this._editor.getOption(144 /* EditorOption.inlayHints */);
    ...
    _updateHintsDecorators(ranges, items) {
        ...
        const maxLength = this._editor.getOption(144 /* EditorOption.inlayHints */).maximumLength;
