...
let HoverColorPickerParticipant = class HoverColorPickerParticipant {
    ...
    _isValidRequest(source) {
        const decoratorActivatedOn = this._editor.getOption(151 /* EditorOption.colorDecoratorsActivatedOn */);
        switch (source) {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        this._colorPicker = disposables.add(new ColorPickerWidget(context.fragment, model, editor.getOption(146 /* EditorOption.pixelRatio */), this._themeService, "hover" /* ColorPickerWidgetType.Hover */));
