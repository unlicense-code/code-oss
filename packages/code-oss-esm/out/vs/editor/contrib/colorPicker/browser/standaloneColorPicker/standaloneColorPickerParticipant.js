...
let StandaloneColorPickerParticipant = class StandaloneColorPickerParticipant {
    ...
    renderHoverParts(context, hoverParts) {
        ...
        const colorPicker = disposables.add(new ColorPickerWidget(context.fragment, model, this._editor.getOption(146 /* EditorOption.pixelRatio */), this._themeService, "standalone" /* ColorPickerWidgetType.Standalone */));
