...
let CopyPasteController = class CopyPasteController extends Disposable {
    ...
    constructor(editor, instantiationService, _bulkEditService, _clipboardService, _configService, _languageFeaturesService, _quickInputService, _progressService) {
        super();
    ...
    isPasteAsEnabled() {
        return this._editor.getOption(87 /* EditorOption.pasteAs */).enabled;
    }
    async finishedPaste() {
    ...
    async handlePaste(e) {
        ...
        if (this._editor.getOption(94 /* EditorOption.readOnly */) // Never enabled if editor is readonly.
        ...
        const p = createCancelablePromise(async (pToken) => {
            ...
            try {
                ...
                if (editSession.edits.length) {
                    const canShowWidget = editor.getOption(87 /* EditorOption.pasteAs */).showPasteSelector === 'afterPaste';
