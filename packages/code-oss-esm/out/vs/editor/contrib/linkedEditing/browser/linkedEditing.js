...
let LinkedEditingContribution = class LinkedEditingContribution extends Disposable {
    ...
    constructor(editor, contextKeyService, languageFeaturesService, languageConfigurationService, languageFeatureDebounceService) {
        ...
        this._register(this._editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(71 /* EditorOption.linkedEditing */) || e.hasChanged(96 /* EditorOption.renameOnType */)) {
    ...
    reinitialize(forceRefresh) {
        ...
        const isEnabled = model !== null && (this._editor.getOption(71 /* EditorOption.linkedEditing */) || this._editor.getOption(96 /* EditorOption.renameOnType */)) && this._providers.has(model);
