...
export class StickyScrollWidget extends Disposable {
    constructor(_editor) {
        ...
        const updateScrollLeftPosition = () => {
            this._linesDomNode.style.left = this._editor.getOption(118 /* EditorOption.stickyScroll */).scrollWithEditor ? `-${this._editor.getScrollLeft()}px` : '0px';
        };
        this._register(this._editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(118 /* EditorOption.stickyScroll */)) {
    ...
    _setFoldingHoverListeners() {
        const showFoldingControls = this._editor.getOption(113 /* EditorOption.showFoldingControls */);
