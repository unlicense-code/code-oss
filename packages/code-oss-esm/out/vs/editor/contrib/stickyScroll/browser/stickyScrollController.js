...
let StickyScrollController = class StickyScrollController extends Disposable {
    ...
    _readConfiguration() {
        const options = this._editor.getOption(118 /* EditorOption.stickyScroll */);
    ...
    _readConfigurationChange(event) {
        if (event.hasChanged(118 /* EditorOption.stickyScroll */)
            || event.hasChanged(74 /* EditorOption.minimap */)
            || event.hasChanged(68 /* EditorOption.lineHeight */)
            || event.hasChanged(113 /* EditorOption.showFoldingControls */)
    ...
    findScrollWidgetState() {
        ...
        const maxNumberStickyLines = Math.min(this._maxStickyLines, this._editor.getOption(118 /* EditorOption.stickyScroll */).maxLineCount);
