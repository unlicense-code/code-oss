...
let ExtensionEnablementService = class ExtensionEnablementService extends Disposable {
    ...
    throwErrorIfEnablementStateCannotBeChanged(extension, enablementStateOfExtension, donotCheckDependencies) {
        switch (enablementStateOfExtension) {
            ...
            case 5 /* EnablementState.DisabledByInvalidExtension */:
            ...
            case 6 /* EnablementState.DisabledByExtensionDependency */:
    ...
    async setEnablement(extensions, newState) {
        ...
        if (newState === 9 /* EnablementState.EnabledGlobally */ || newState === 10 /* EnablementState.EnabledWorkspace */) {
        ...
        const workspace = newState === 8 /* EnablementState.DisabledWorkspace */ || newState === 10 /* EnablementState.EnabledWorkspace */;
        ...
        for (const extension of extensions) {
            ...
            if (enablementState === 0 /* EnablementState.DisabledByTrustRequirement */
                ...
                || (enablementState === 6 /* EnablementState.DisabledByExtensionDependency */ && this.getDependenciesEnablementStates(extension).every(([, e]) => this.isEnabledEnablementState(e) || e === 0 /* EnablementState.DisabledByTrustRequirement */))) {
    ...
    _setUserEnablementState(extension, newState) {
        ...
        switch (newState) {
            case 9 /* EnablementState.EnabledGlobally */:
            ...
            case 7 /* EnablementState.DisabledGlobally */:
                ...
                break;
            case 10 /* EnablementState.EnabledWorkspace */:
    ...
    isEnabledEnablementState(enablementState) {
        return enablementState === 3 /* EnablementState.EnabledByEnvironment */ || enablementState === 10 /* EnablementState.EnabledWorkspace */ || enablementState === 9 /* EnablementState.EnabledGlobally */;
    }
    ...
    _computeEnablementState(extension, extensions, workspaceType, computedEnablementStates) {
        ...
        if (isEnabled && !extension.isValid) {
            enablementState = 5 /* EnablementState.DisabledByInvalidExtension */;
        }
            ...
            enablementState = 6 /* EnablementState.DisabledByExtensionDependency */;
        }
    ...
    _isDisabledByExtensionDependency(extension, extensions, workspaceType, computedEnablementStates) {
        ...
        if (!hasEnablementState) {
            ...
            computedEnablementStates.set(extension, 9 /* EnablementState.EnabledGlobally */);
        }
        try {
    ...
    _getUserEnablementState(identifier) {
        if (this.hasWorkspace) {
            if (this._getWorkspaceEnabledExtensions().filter(e => areSameExtensions(e, identifier))[0]) {
                return 10 /* EnablementState.EnabledWorkspace */;
            }
            if (this._getWorkspaceDisabledExtensions().filter(e => areSameExtensions(e, identifier))[0]) {
                return 8 /* EnablementState.DisabledWorkspace */;
            }
        }
        if (this._isDisabledGlobally(identifier)) {
            return 7 /* EnablementState.DisabledGlobally */;
        }
        return 9 /* EnablementState.EnabledGlobally */;
    }
    ...
    _onDidChangeExtensions(added, removed, isProfileSwitch) {
        ...
        this.extensionsDisabledByExtensionDependency = this.extensionsManager.extensions.filter(extension => this.getEnablementState(extension) === 6 /* EnablementState.DisabledByExtensionDependency */);
