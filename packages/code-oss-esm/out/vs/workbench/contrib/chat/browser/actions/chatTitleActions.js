...
import { EDITS_VIEW_ID, IChatWidgetService } from '../chat.js';
        ...
        async run(accessor, ...args) {
            ...
            if (request) {
                ...
                if (widget.viewModel) {
                    ...
                    chatService.addCompleteRequest(widget.viewModel.sessionId, request.message, request.variableData, request.attempt, {
                        message,
