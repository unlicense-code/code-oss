...
let DropOrPasteInto = class DropOrPasteInto {
...
DropOrPasteInto = __decorate([
    __param(0, IPreferencesService)
], DropOrPasteInto);
registerWorkbenchContribution2(DropOrPasteInto.ID, DropOrPasteInto, 4 /* WorkbenchPhase.Eventually */);
