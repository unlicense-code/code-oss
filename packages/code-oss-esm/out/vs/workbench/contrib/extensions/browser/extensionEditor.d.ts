...
export declare class ExtensionEditor extends EditorPane {
    ...
    constructor(group: IEditorGroup, telemetryService: ITelemetryService, instantiationService: IInstantiationService, extensionsWorkbenchService: IExtensionsWorkbenchService, extensionGalleryService: IExtensionGalleryService, themeService: IThemeService, notificationService: INotificationService, openerService: IOpenerService, extensionRecommendationsService: IExtensionRecommendationsService, storageService: IStorageService, extensionService: IExtensionService, webviewService: IWebviewService, languageService: ILanguageService, contextMenuService: IContextMenuService, contextKeyService: IContextKeyService, contextService: IWorkspaceContextService, explorerService: IExplorerService, viewsService: IViewsService, uriIdentityService: IUriIdentityService, hoverService: IHoverService, userDataProfilesService: IUserDataProfilesService, remoteAgentService: IRemoteAgentService, fileService: IFileService);
