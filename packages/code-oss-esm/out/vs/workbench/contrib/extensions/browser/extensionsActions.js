...
let PromptExtensionInstallFailureAction = class PromptExtensionInstallFailureAction extends Action {
    ...
    async getDownloadUrl() {
        ...
        return URI.parse(`${this.productService.extensionsGallery.serviceUrl}/publishers/${this.extension.publisher}/vsextensions/${this.extension.name}/${this.version}/vspackage${targetPlatform !== "undefined" /* TargetPlatform.UNDEFINED */ ? `?targetPlatform=${targetPlatform}` : ''}`);
    }
};
...
let EnableForWorkspaceAction = class EnableForWorkspaceAction extends ExtensionAction {
    ...
    async run() {
        ...
        return this.extensionsWorkbenchService.setEnablement(this.extension, 10 /* EnablementState.EnabledWorkspace */);
    }
};
...
let EnableGloballyAction = class EnableGloballyAction extends ExtensionAction {
    ...
    async run() {
        ...
        return this.extensionsWorkbenchService.setEnablement(this.extension, 9 /* EnablementState.EnabledGlobally */);
    }
};
...
let DisableForWorkspaceAction = class DisableForWorkspaceAction extends ExtensionAction {
    ...
    update() {
        ...
        if (this.extension && this.extension.local && !this.extension.isWorkspaceScoped && this.extensionService.extensions.some(e => areSameExtensions({ id: e.identifier.value, uuid: e.uuid }, this.extension.identifier) && this.workspaceContextService.getWorkbenchState() !== 1 /* WorkbenchState.EMPTY */)) {
            this.enabled = this.extension.state === 1 /* ExtensionState.Installed */
                && (this.extension.enablementState === 9 /* EnablementState.EnabledGlobally */ || this.extension.enablementState === 10 /* EnablementState.EnabledWorkspace */)
                && this.extensionEnablementService.canChangeWorkspaceEnablement(this.extension.local);
        }
    }
    async run() {
        ...
        return this.extensionsWorkbenchService.setEnablement(this.extension, 8 /* EnablementState.DisabledWorkspace */);
    }
};
...
let DisableGloballyAction = class DisableGloballyAction extends ExtensionAction {
    ...
    async run() {
        ...
        return this.extensionsWorkbenchService.setEnablement(this.extension, 7 /* EnablementState.DisabledGlobally */);
    }
};
...
let ExtensionStatusAction = class ExtensionStatusAction extends ExtensionAction {
    ...
    async computeAndUpdateStatus() {
        ...
        if (this.extension.state === 3 /* ExtensionState.Uninstalled */ && this.extension.gallery && !this.extension.gallery.isSigned) {
        ...
        if (this.extension.enablementState === 6 /* EnablementState.DisabledByExtensionDependency */) {
            this.updateStatus({
                icon: warningIcon,
        ...
        if (!this.extension.isWorkspaceScoped && isEnabled && isRunning) {
            if (this.extension.enablementState === 10 /* EnablementState.EnabledWorkspace */) {
            ...
            if (this.extension.enablementState === 9 /* EnablementState.EnabledGlobally */) {
                return;
            }
        }
        if (!isEnabled && !isRunning) {
            if (this.extension.enablementState === 7 /* EnablementState.DisabledGlobally */) {
            ...
            if (this.extension.enablementState === 8 /* EnablementState.DisabledWorkspace */) {
