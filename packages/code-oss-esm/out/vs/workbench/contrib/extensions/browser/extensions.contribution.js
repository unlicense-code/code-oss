        ...
        this.registerExtensionAction({
            ...
            run: async () => {
                ...
                if (extensionsToEnable.length) {
                    await this.extensionsWorkbenchService.setEnablement(extensionsToEnable, 9 /* EnablementState.EnabledGlobally */);
                }
            }
        });
        this.registerExtensionAction({
            ...
            run: async () => {
                const extensionsToEnable = this.extensionsWorkbenchService.local.filter(e => !!e.local && this.extensionEnablementService.canChangeEnablement(e.local) && !this.extensionEnablementService.isEnabled(e.local));
                if (extensionsToEnable.length) {
                    await this.extensionsWorkbenchService.setEnablement(extensionsToEnable, 10 /* EnablementState.EnabledWorkspace */);
                }
            }
        });
        this.registerExtensionAction({
            ...
            run: async () => {
                ...
                if (extensionsToDisable.length) {
                    await this.extensionsWorkbenchService.setEnablement(extensionsToDisable, 7 /* EnablementState.DisabledGlobally */);
                }
            }
        });
        this.registerExtensionAction({
            ...
            run: async () => {
                const extensionsToDisable = this.extensionsWorkbenchService.local.filter(e => !e.isBuiltin && !!e.local && this.extensionEnablementService.isEnabled(e.local) && this.extensionEnablementService.canChangeEnablement(e.local));
                if (extensionsToDisable.length) {
                    await this.extensionsWorkbenchService.setEnablement(extensionsToDisable, 8 /* EnablementState.DisabledWorkspace */);
                }
            }
        });
        this.registerExtensionAction({
