...
suite('ExtensionsViews Tests', () => {
    ...
    setup(async () => {
        ...
        await instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localDisabledTheme], 7 /* EnablementState.DisabledGlobally */);
        await instantiationService.get(IWorkbenchExtensionEnablementService).setEnablement([localDisabledLanguage], 7 /* EnablementState.DisabledGlobally */);
