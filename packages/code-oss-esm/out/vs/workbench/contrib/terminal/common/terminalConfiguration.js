...
const terminalConfiguration = {
    ...
    properties: {
        ...
        ["terminal.integrated.fontLigatures" /* TerminalSettingId.FontLigatures */]: {
            markdownDescription: localize('terminal.integrated.fontLigatures', "Controls whether font ligatures are enabled in the terminal. Ligatures will only work if the configured {0} supports them.", `\`#${"terminal.integrated.fontFamily" /* TerminalSettingId.FontFamily */}#\``),
            type: 'boolean',
            tags: ['preview'],
            default: false
        },
        ...
        ["terminal.integrated.experimental.windowsUseConptyDll" /* TerminalSettingId.ExperimentalWindowsUseConptyDll */]: {
