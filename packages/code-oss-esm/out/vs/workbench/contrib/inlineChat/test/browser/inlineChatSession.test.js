...
suite('InlineChatSession', function () {
    ...
    test('Create, release', async function () {
        const session = await inlineChatSessionService.createSession(editor, { editMode: "live" /* EditMode.Live */ }, CancellationToken.None);
        assertType(session);
