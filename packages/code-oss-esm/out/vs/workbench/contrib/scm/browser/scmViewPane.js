...
let ResourceGroupRenderer = class ResourceGroupRenderer {
    ...
    constructor(actionViewItemProvider, commandService, contextKeyService, contextMenuService, keybindingService, menuService, scmViewService, telemetryService) {
...
let SCMInputWidget = class SCMInputWidget {
    ...
    getContentHeight() {
        ...
        const { top, bottom } = this.inputEditor.getOption(86 /* EditorOption.padding */);
