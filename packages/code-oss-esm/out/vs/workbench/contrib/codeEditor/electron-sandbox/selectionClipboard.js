...
let SelectionClipboard = class SelectionClipboard extends Disposable {
    ...
    constructor(editor, clipboardService) {
        super();
        if (platform.isLinux) {
            let isEnabled = editor.getOption(110 /* EditorOption.selectionClipboard */);
            this._register(editor.onDidChangeConfiguration((e) => {
                if (e.hasChanged(110 /* EditorOption.selectionClipboard */)) {
                    isEnabled = editor.getOption(110 /* EditorOption.selectionClipboard */);
                }
            }));
